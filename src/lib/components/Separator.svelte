<div class="flex w-full h-fit py-5">
	<svg
		width="100%"
		height="80px"
		viewBox="0 0 1200 80"
	...
	>
		...
		<!-- Main wavy line with gentle slope from left to right -->
		<path
			class="wave1"
			d="M 0 25 
      Q 150 15, 300 30
      ...
      Z"
		...
		<!-- Second layer for thickness variation -->
		<path
			class="wave2"
			d="M 0 30
      Q 200 18, 400 35
      ...
      Z"
		...
		<!-- Third layer for more organic variation -->
		<path
			class="wave3"
			d="M 0 27
      Q 250 20, 500 32
